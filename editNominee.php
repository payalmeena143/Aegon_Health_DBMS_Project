...
<?php 
   ...
   include'connection.php';
	...
	while($row = $result->fetch_assoc()) {
		...
		echo "<input type=\"text\" claim_id=\"fname\" name=\"policy_id\" placeholder=\"policy id..\" value=\"$row[policy_id]\">";
        echo "<label for=\"fname\">NID</label>";
		echo "<input type=\"text\" claim_id=\"fname\" name=\"nid\" placeholder=\"claim NID..\" value=\"$row[nid]\">";
